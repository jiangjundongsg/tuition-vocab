    ...
    <div className={`bg-white rounded-xl border transition-colors ${
      ...
      <div className="flex items-center gap-3 mb-3">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 disabled:opacity-60 text-white rounded-lg text-sm font-semibold transition-colors"
        >
      ...
      <div className="flex gap-2">
        <input
          ...
          disabled={submitted}
          className="flex-1 border border-slate-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-400 disabled:bg-slate-50 transition-colors"
        />
        {!submitted && (
          <button
            onClick={submit}
