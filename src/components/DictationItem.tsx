    ...
    <div className={`bg-white rounded-xl border transition-colors ${
      ...
      <div className="flex gap-2">
        <input
          ...
          disabled={submitted}
          className="flex-1 border border-slate-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-indigo-400 focus:ring-1 focus:ring-indigo-400 disabled:bg-slate-50 transition-colors"
        />
        {!submitted && (
          <button
            onClick={submit}
